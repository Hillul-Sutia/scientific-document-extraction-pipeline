...
class PostExtractionVerificationTests(unittest.TestCase):
    def test_saved_tables_are_verified_without_llm(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            write_json(tables_dir / "table6.json", [{
                "food_id": "F0001",
                "food_name": "kimchi",
            ...
            verified_table7 = read_json(output_dir / "verified" / "table7.json")
            ...
            self.assertEqual(verified_table7, [{
                "microbe": "Lactobacillus plantarum",
                "count": 1,
            }])
